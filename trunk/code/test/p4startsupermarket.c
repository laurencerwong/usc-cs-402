...
void main(){
  ...
  /*Salesmen Next*/
  Exec("../test/salesman", sizeof("../test/salesman"), "salesman0 thread", sizeof("salesman0 thread"));
  Exec("../test/salesman", sizeof("../test/salesman"), "salesman1 thread", sizeof("salesman1 thread"));
  Exec("../test/salesman", sizeof("../test/salesman"), "salesman2 thread", sizeof("salesman2 thread"));
